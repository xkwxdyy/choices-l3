...
\date{2021-12-30\quad v3.1.1 \thanks{\url{https://github.com/xkwxdyy/choice-l3}}}
\begin{document}
\maketitle
\tableofcontents
...
\begin{function}[added = 2021-12-25]{autopic, autopic-anchor}
  ...
  \end{syntax}
  \pkg{choices} 宏包设置了检测是否内容中包含 \tn{includegraphics} 命令并自动进行 \kvopt{\meta{anchor}}{\meta{方位}} 的设置, 默认是\kvopt{\meta{anchor}}{\meta{south}}, 更改 \cmd{autopic} 的值可更改默认方位.
